...
NOTE: [You can find here](https://github.com/hs-hq/0x1D.c/tree/main/skiplist) the functions used in the example. You don’t need to push them, we will compile your file with our own implementation during the correction.
```
